...
from flgo import __version__
from flgo.config import Settings, get_settings
...
from flgo.server.admin import mount_admin_routes
...
def create_app(settings: Settings | None = None) -> FastAPI:
    ...
    app = FastAPI(title=settings.assistant_default_name, version=__version__, lifespan=lifespan)
