...
set FLGO_ENV=prod
set FLGO_RESTART_TIMEOUT_SECONDS=120
...
export FLGO_ENV="${FLGO_ENV:-prod}"
export FLGO_RESTART_TIMEOUT_SECONDS="${FLGO_RESTART_TIMEOUT_SECONDS:-120}"
...
def _prepare_portable_env_example(path: Path) -> None:
    ...
    replacements = {
        "FLGO_ENV": "prod",
        "FLGO_START_LONG_CONNECTION": "false",
        "FLGO_ADMIN_SESSION_SECRET": "",
        "FEISHU_APP_ID": "",
        "FEISHU_APP_SECRET": "",
        "GEMINI_API_KEY": "",
        "OPENAI_API_KEY": "",
    ...
    append_missing = {"FLGO_ENV", "FLGO_START_LONG_CONNECTION"}
