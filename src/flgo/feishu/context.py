...
from flgo.feishu.message import _message_text as _extract_message_text
from flgo.models import AuditEventType, ChatContextMessage, ConversationType, FeishuMessage
...
def conversation_memory_source(scope: str) -> str:
    return f"flgo.context.summary:{scope}"
